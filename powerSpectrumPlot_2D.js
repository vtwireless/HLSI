 ...
 *
 * @param {Object} [opts] - An options object that can contain properties to configure the plot.
 ...
 * @param {boolean} [opts.has_interferer=true] - A flag indicating whether the plot should include an interferer signal.
 * If `true`, the plot will display the interferer signal; otherwise, it will exclude it.
 * @returns {void} This function does not return a value. It generates and displays a Power Spectrum Plot
 * based on the provided options and signals, updating the visualization with signal and noise parameters.
 */
