...
var conf = {
    ...
    schemes: [
        { rate: 0.50000, SNR: 3.979, name: 'r1/2 BPSK'},  //    0
        { rate: 0.66667, SNR: 5.703, name: 'r2/3 BPSK'},  //    1
        { rate: 1.00000, SNR: 7.109, name: 'r1/2 QPSK'},  //    2
        ...
        { rate: 4.44444, SNR:20.970, name: 'r8/9 32-QAM'},//    7
        { rate: 5.33333, SNR:22.920, name: 'r8/9 64-QAM'},//    8
        { rate: 6.22222, SNR:26.797, name: 'r8/9 128-QAM'},//   9
        { rate: 7.11111, SNR:28.570, name: 'r8/9 256-QAM'},//  10
        { rate: 8.00000, SNR:31.050, name: 'uncoded 256-QAM'}//11
    ],
    ...
    sig0: {
        ...
        freq_min: 1780.0e+6,
        freq_max: 1820.0e+6,
        freq_plot_min: 1780.0e+6,
        freq_plot_max: 1820.0e+6,
        freq_step: 0.01e+6,
        freq_init: 1800.0e+6,
    ...
    sig1: {
        ...
        freq_plot_min: 913.5e+6,
        freq_plot_max: 917.5e+6,
        //
