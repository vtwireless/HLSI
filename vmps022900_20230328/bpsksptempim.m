function bpsksptempim(X1Y1,X2Y2,XY1,XY2,XY3,XY4,XY5,XY6,active,freq,samp,Ts,taps,Eborange,ntaps,pwr,gamma,los,flag1,flag2,berflag,flagap,flagap1,txd,seq,filename)
%%%
%%%
tic
mult1=[];
...
bits=length(seq);
fprintf('Number of bits in Image: %d \n',bits)
lambda=3e8/freq;
bitcount=0;
BBITS=[];
minmult=inf;
...
if flagap1==1
   antennapat(X2Y2,lambda,ccoef,mult1,anglemult1,mult2,anglemult2,mult3,anglemult3,mult4,anglemult4,mult5,anglemult5,mult6,anglemult6,usu,active);
