% sloop(thetares,phires,'filename')  
% Generates the pattern for a horizontally oriented infinitesimal loop antenna.  
% "thetares" is the sampling resolution in theta in degrees.
% "phires" is the sampling resolution in phi in degrees.
% "filename" is the path and filename for the antenna pattern files.  
