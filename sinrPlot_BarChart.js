/* This JavaScript code defines an object `SinrPlot_BarChart` that handles the creation and updating of
a bar chart representing SINR (Signal-to-Interference-plus-Noise Ratio) values. Here is a breakdown
...
const SinrPlot_BarChart = {
  ...
  update_plot: function () {
    ...
    let new_dataset = SinrPlot_BarChart.generate_dataset(
